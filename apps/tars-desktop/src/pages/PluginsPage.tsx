        ...
        <section className="rounded-md border border-border bg-muted/20 p-5">
          <div className="max-w-3xl">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Install and manage plugins for Claude Code. A plugin bundles skills, commands, agents,
              and MCP servers, and toggles on or off as a single unit.{' '}
              <button
                onClick={() => navigate('/skill-library')}
                className="text-primary hover:underline"
              >
                Standalone skills — and all Codex skills — live in the Skill Library →
              </button>
            </p>
          </div>
        </section>
